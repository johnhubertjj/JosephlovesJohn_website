...
def test_intro_route_sets_hash_and_activates_intro_article(browser_page, live_server) -> None:
    ...
    assert browser_page.locator('[data-cookie-src="https://josephlovesjohn.kit.com/408ee57c19/index.js"]').count() == 1
    assert browser_page.locator('[data-cookie-banner]').is_visible()
    assert browser_page.locator('script[data-uid="408ee57c19"]').count() == 0
